...
#np.random.seed(3323534) #fix random seeds for reproducability
#torch.manual_seed(42223)
...
#torch.manual_seed(1235464323543)
T = FlowStep(dt)
...
if method == 'IM':
    with open("flow_results_invariant.p", "wb") as f:
         pickle.dump([pred,ode_sampling_freq,dts_sub,dts_data], f)
if method == 'DIM':
         with open("flow_results_measure.p", "wb") as f:
              pickle.dump([pred,ode_sampling_freq,dts_sub,dts_data], f)
